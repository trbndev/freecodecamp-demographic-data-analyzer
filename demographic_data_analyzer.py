...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(
        df[df["education"] == "Bachelors"].size / df.size * 100, 1
    )
    ...
    higher_education = df[df["education"].isin(advanced_education_degrees)]

    lower_education = df[~df["education"].isin(advanced_education_degrees)]
    ...
    rich_percentage = round(
        num_min_workers[num_min_workers["salary"] == ">50K"].size
